...
import homework_01.GeometryCalculator;
...
public class TestGetTriangleSquare {
    ...
    void testGetTriangleSquareWithWrongPositiveSides() {
        double expected = -1;
        Assertions.assertEquals(expected, GeometryCalculator.getTriangleSquare(1, 20, 40), DELTA);
    }
    ...
    void testGetTriangleSquareWithRightPositiveSides() {
        double expected = 6.0;
        Assertions.assertEquals(expected, GeometryCalculator.getTriangleSquare(3, 4, 5), DELTA);
    }
    ...
    void testGetTriangleSquareWithZeroSides() {
        double expected = -1;
        Assertions.assertEquals(expected, GeometryCalculator.getTriangleSquare(0, 0, 0), DELTA);
    }
    ...
    void testGetTriangleSquareWithOneZeroSideAndTwoPositiveSides() {
        double expected = -1;
        Assertions.assertEquals(expected, GeometryCalculator.getTriangleSquare(3, 0, 5), DELTA);
    }
    ...
    void testGetTriangleSquareWithOneFractionalSideAndTwoPositiveSides() {
        ...
        Assertions.assertEquals(expected, GeometryCalculator.getTriangleSquare(1.5, 2, 3), DELTA);
    }
    ...
    void testGetTriangleSquareWithOneFractionalSides() {
        ...
        Assertions.assertEquals(expected, GeometryCalculator.getTriangleSquare(1.5, 2.6, 3.7), DELTA);
    }
