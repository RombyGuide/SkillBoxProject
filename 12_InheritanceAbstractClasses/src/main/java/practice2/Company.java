...
public class Company {
     ...
     * @return true - если сотрудник нанят в компанию (успешно добавлен в коллекцию сотрудников).
     */
     ...
     * @return true - если все сотрудники из списка наняты в компанию (успешно добавлены в
