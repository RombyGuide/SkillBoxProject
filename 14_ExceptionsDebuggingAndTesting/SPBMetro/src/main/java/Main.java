...
public class Main {
    ...
    private static final String DATA_FILE =
            "C:\\Users\\blino\\IdeaProjects\\SkillBox_Java" +
                    "\\14_ExceptionsDebuggingAndTesting" +
                    "\\SPBMetro\\src\\main\\resources\\map.json";
        ...
        for (; ; ) {
            try {
                ...
                throw new IllegalArgumentException(
                        "Генерируемый exception после подсчета времени");
